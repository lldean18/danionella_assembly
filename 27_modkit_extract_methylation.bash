...
##    fish_A_simp_meth_0.85_2comb.bed \
##    --log-filepath fish_A_simp_0.85_modkit_2comb.log \
...
modkit pileup \
  ...
  fish_A_dup_meth_0.85_2comb.bed \
  --log-filepath fish_A_dup_modkit_0.85_2comb.log \
  --reference /share/deepseq/shenson/ds1664_Wilkinson/03_medaka/consensus.fasta \
  --threads 8 \
  --combine-strands \
  --combine-mods \
