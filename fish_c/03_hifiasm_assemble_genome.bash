...
awk '/^S/{print ">"$2;print $3}' fish_c.bp.p_ctg.gfa > fish_c.bp.p_ctg.fasta
awk '/^S/{print ">"$2;print $3}' fish_c.bp.hap1.p_ctg.gfa > fish_c.bp.hap1.p_ctg.fasta
awk '/^S/{print ">"$2;print $3}' fish_c.bp.hap2.p_ctg.gfa > fish_c.bp.hap2.p_ctg.fasta
